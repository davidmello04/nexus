...
export function OrderDetailsPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <section className="mt-4 rounded-2xl border border-white/80 bg-white/72 p-4 shadow-sm shadow-blue-100/50">
          ...
          <dl className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <DetailItem
              ...
              icon={Tag}
            />
            <DetailItem label="Código" value={`#${order.code}`} icon={Hash} />
            <DetailItem
              label="Criado em"
      ...
      {order.quote && (
        <section className="rounded-2xl border border-blue-200 bg-blue-50/80 px-4 py-3 text-blue-900 shadow-sm shadow-blue-100/70">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Link
              ...
              className="cursor-pointer rounded-xl bg-blue-700 px-3 py-1.5 text-sm font-medium text-white transition hover:bg-blue-800"
            >
              Ver orçamento
            </Link>
          </div>
      ...
      <section className="overflow-hidden rounded-3xl border border-white/80 bg-white shadow-sm shadow-slate-200/70 ring-1 ring-slate-900/5">
        <div className="border-b border-blue-100 bg-gradient-to-r from-blue-50/70 to-white p-5">
          <div className="flex items-center gap-3">
        ...
        <div className="flex justify-end border-t border-blue-100 bg-gradient-to-r from-white to-blue-50/50 p-5">
          <div className="w-full max-w-sm rounded-2xl border border-blue-100 bg-white/80 p-4 text-sm shadow-sm shadow-blue-100/50">
    ...
    <div
      className={[
        ...
        accent
          ...
          : statusClassName || 'border-white/80 bg-white/75 text-slate-900 shadow-blue-100/50',
      ].join(' ')}
    >
...
function getStatusStatClassName(status: string) {
  const classNames: Record<string, string> = {
    DRAFT: 'border-slate-200 bg-slate-100/80 text-slate-800 shadow-slate-200/70',
    PENDING: 'border-blue-200 bg-blue-50/90 text-blue-800 shadow-blue-100/70',
    IN_PRODUCTION:
      'border-amber-200 bg-amber-50/90 text-amber-900 shadow-amber-100/70',
    DONE: 'border-emerald-200 bg-emerald-50/90 text-emerald-800 shadow-emerald-100/70',
    CANCELED: 'border-red-200 bg-red-50/90 text-red-800 shadow-red-100/70',
  }
    ...
    <div
      className={[
        ...
        accent
          ...
          : 'border-slate-100 bg-white/78 shadow-slate-100/60',
      ].join(' ')}
    >
