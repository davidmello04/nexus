...
export function QuoteDetailsPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <section className="mt-4 rounded-2xl border border-white/80 bg-white/72 p-4 shadow-sm shadow-blue-100/50">
          ...
          <dl className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <DetailItem
              ...
              icon={Tag}
            />
            <DetailItem label="Código" value={`#${quote.code}`} icon={Hash} />
            <DetailItem
              label="Criado em"
      ...
      {quote.order && (
        <section className="rounded-2xl border border-emerald-200 bg-emerald-50/80 px-4 py-3 text-emerald-900 shadow-sm shadow-emerald-100/70">
...
function getQuoteStatusStatClassName(status: string) {
  const classNames: Record<string, string> = {
    ...
    SENT: 'border-blue-200 bg-blue-50/90 text-blue-800 shadow-blue-100/70',
    APPROVED:
      'border-emerald-200 bg-emerald-50/90 text-emerald-800 shadow-emerald-100/70',
    REJECTED: 'border-red-200 bg-red-50/90 text-red-800 shadow-red-100/70',
    EXPIRED:
      'border-purple-200 bg-purple-50/90 text-purple-800 shadow-purple-100/70',
  }
