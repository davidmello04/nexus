...
export class CompanySettingsService {
  ...
  private normalizeData(upsertCompanySettingsDto: UpsertCompanySettingsDto) {
    return {
      ...
      addressZipCode: upsertCompanySettingsDto.addressZipCode ?? '',
      addressStreet: upsertCompanySettingsDto.addressStreet ?? '',
      addressNumber: upsertCompanySettingsDto.addressNumber ?? '',
      addressComplement: upsertCompanySettingsDto.addressComplement ?? '',
      addressNeighborhood: upsertCompanySettingsDto.addressNeighborhood ?? '',
      addressCity: upsertCompanySettingsDto.addressCity ?? '',
      addressState: upsertCompanySettingsDto.addressState ?? '',
